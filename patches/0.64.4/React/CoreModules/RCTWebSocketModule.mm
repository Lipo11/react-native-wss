                  ...
                  : (double)socketID)
{
  ...
  NSDictionary * wssOptions = @{ @"pfx": options.pfx(), @"passphrase": options.passphrase(), @"ca": options.ca() };
  RCTSRWebSocket *webSocket = [[RCTSRWebSocket alloc] initWithURLRequest:request protocols:protocols options:wssOptions];
