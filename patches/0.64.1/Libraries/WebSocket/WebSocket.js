...
class WebSocket extends (EventTarget(...WEBSOCKET_EVENTS): any) {
  ...
  constructor(url: string, protocols: ?string | ?Array<string>, options: ?{headers?: {origin?: string}, pfx?: string, passphrase?: string, ca?: string }) {
    super();
    if (typeof protocols === 'string') {
      protocols = [protocols];
    }
    
    const {headers = {}, pfx = '', passphrase = '', ca = '', ...unrecognized} = options || {};
    ...
    NativeWebSocketModule.connect(url, protocols, { headers, pfx, passphrase, ca }, this._socketId);
  }
